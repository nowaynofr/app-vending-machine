...
QT_MOC_LITERAL(4, 58, 16), // "Signal_Next_Form"
QT_MOC_LITERAL(5, 75, 30), // "on_Btn_Ok_Menu_General_clicked"
QT_MOC_LITERAL(6, 106, 32), // "on_Btn_Back_Menu_General_clicked"
QT_MOC_LITERAL(7, 139, 45), // "on_Btn_increase_quantity_Menu..."
QT_MOC_LITERAL(8, 185, 17), // "on_Btn_next_click"
QT_MOC_LITERAL(9, 203, 45), // "on_Btn_decrease_quantity_Menu..."
QT_MOC_LITERAL(10, 249, 9), // "Back_Home"
QT_MOC_LITERAL(11, 259, 19) // "select_good_clicked"

    },
    "menu_good_general\0Signal_Menu_Good_General\0"
    "\0MACHINE_STATE\0Signal_Next_Form\0"
    "on_Btn_Ok_Menu_General_clicked\0"
...
void menu_good_general::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->Signal_Next_Form((*reinterpret_cast< MACHINE_STATE(*)>(_a[1]))); break;
        case 2: _t->on_Btn_Ok_Menu_General_clicked(); break;
        case 3: _t->on_Btn_Back_Menu_General_clicked(); break;
        case 4: _t->on_Btn_increase_quantity_Menu_General_clicked(); break;
        case 5: _t->on_Btn_next_click(); break;
        case 6: _t->on_Btn_decrease_quantity_Menu_General_clicked(); break;
        case 7: _t->Back_Home((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 8: _t->select_good_clicked((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (menu_good_general::*)(MACHINE_STATE );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&menu_good_general::Signal_Next_Form)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void menu_good_general::Signal_Next_Form(MACHINE_STATE _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
