...
QT_MOC_LITERAL(1, 9, 21), // "Signal_Test_Form_Back"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 13), // "MACHINE_STATE"
QT_MOC_LITERAL(4, 46, 25), // "on_Btn_Back_login_clicked"
QT_MOC_LITERAL(5, 72, 21) // "on_pushButton_clicked"

    },
    "testform\0Signal_Test_Form_Back\0\0"
    "MACHINE_STATE\0on_Btn_Back_login_clicked\0"
...
void testform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Signal_Test_Form_Back((*reinterpret_cast< MACHINE_STATE(*)>(_a[1]))); break;
        ...
        {
            using _t = void (testform::*)(MACHINE_STATE );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&testform::Signal_Test_Form_Back)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void testform::Signal_Test_Form_Back(MACHINE_STATE _t1)
{
