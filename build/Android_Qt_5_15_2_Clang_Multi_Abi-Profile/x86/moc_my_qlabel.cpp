...
QT_MOC_LITERAL(1, 10, 12), // "home_network"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "price"

    },
    "my_qlabel\0home_network\0\0price"
};
...
void my_qlabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->home_network((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->price((*reinterpret_cast< quint32(*)>(_a[1])),(*reinterpret_cast< quint8(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (my_qlabel::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::home_network)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (my_qlabel::*)(quint32 , quint8 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::price)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void my_qlabel::home_network(QString _t1)
{
...
// SIGNAL 1
void my_qlabel::price(quint32 _t1, quint8 _t2)
{
